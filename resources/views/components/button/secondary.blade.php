...
<button
  {{ $attributes->merge([
    'type' => 'button',
    'class' => 'tw-inline-flex tw-justify-center tw-items-center tw-py-0 tw-px-4 tw-m-0 tw-h-10 tw-text-sm tw-font-bold tw-leading-none tw-text-center tw-text-gray-700 tw-uppercase tw-whitespace-nowrap tw-break-words tw-bg-gray-200 tw-rounded-sm tw-cursor-pointer tw-select-none'
  ]) }}
