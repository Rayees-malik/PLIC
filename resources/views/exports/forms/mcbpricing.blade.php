<div class="col-xl-6 mt-4">
    <div class="card">
        <div class="card-header d-flex justify-content-between flex-wrap">
            <h2 class="mb-0">AS400 MCB Data</h2>
        </div>
        <div class="card-body">
            <div class="formContainer">
                <form method="POST" action="{{ route('exports.export', 'mcbpricing') }}">
                    @csrf
                    <div class="container">
                        <div class="row">
                        ...
                        <div class="row input-wrap">
                            ...
                            <div class="checkbox-wrap">
                                <label class="checkbox">
                                    <input type="checkbox" name="cat_code" value="1">
                                    <span class="checkbox-checkmark"></span>
                                    <span class="checkbox-label">Include Cat Codes</span>
                                </label>
                            </div>
                            <div class="checkbox-wrap">
                                <label class="checkbox">
