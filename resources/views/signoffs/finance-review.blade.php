...
@section('page', 'Finance Bulk Approvals')

@section('content')
<div class="container container-xxl">
  <div class="row justify-content-center">
    <div class="col-12">
      <h1 class="mb-0 text-center">Finance Bulk Price Approvals</h1>

      <form id="signoff-form" method="POST" action="{{ route('signoffs.finance.update') }}">
        @csrf
