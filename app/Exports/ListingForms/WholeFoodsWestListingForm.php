...
class WholeFoodsWestListingForm extends SimpleListingForm
{
    const WHOLESALE_BRANDS = [35, 366, 588];

    protected $template = 'templates/listingforms/whole_foods_west.xlsx';

    protected $filename = 'whole_foods_west_listingform.xlsx';
